...
static const char GETCARTESIANPATH[] = "moveit_msgs/GetCartesianPath";
  ...
  class GetCartesianPathRequest : public ros::Msg
  {
    public:
      ...
      typedef double _prismatic_jump_threshold_type;
      _prismatic_jump_threshold_type prismatic_jump_threshold;
      typedef double _revolute_jump_threshold_type;
    ...
    virtual int serialize(unsigned char *outbuffer) const override
    {
      ...
      *(outbuffer + offset + 7) = (u_jump_threshold.base >> (8 * 7)) & 0xFF;
      ...
      union {
        double real;
        uint64_t base;
      } u_prismatic_jump_threshold;
      u_prismatic_jump_threshold.real = this->prismatic_jump_threshold;
      *(outbuffer + offset + 0) = (u_prismatic_jump_threshold.base >> (8 * 0)) & 0xFF;
      *(outbuffer + offset + 1) = (u_prismatic_jump_threshold.base >> (8 * 1)) & 0xFF;
      *(outbuffer + offset + 2) = (u_prismatic_jump_threshold.base >> (8 * 2)) & 0xFF;
      *(outbuffer + offset + 3) = (u_prismatic_jump_threshold.base >> (8 * 3)) & 0xFF;
      *(outbuffer + offset + 4) = (u_prismatic_jump_threshold.base >> (8 * 4)) & 0xFF;
      *(outbuffer + offset + 5) = (u_prismatic_jump_threshold.base >> (8 * 5)) & 0xFF;
      *(outbuffer + offset + 6) = (u_prismatic_jump_threshold.base >> (8 * 6)) & 0xFF;
      *(outbuffer + offset + 7) = (u_prismatic_jump_threshold.base >> (8 * 7)) & 0xFF;
      offset += sizeof(this->prismatic_jump_threshold);
      union {
        double real;
        uint64_t base;
      } u_revolute_jump_threshold;
      u_revolute_jump_threshold.real = this->revolute_jump_threshold;
      *(outbuffer + offset + 0) = (u_revolute_jump_threshold.base >> (8 * 0)) & 0xFF;
      *(outbuffer + offset + 1) = (u_revolute_jump_threshold.base >> (8 * 1)) & 0xFF;
      *(outbuffer + offset + 2) = (u_revolute_jump_threshold.base >> (8 * 2)) & 0xFF;
      *(outbuffer + offset + 3) = (u_revolute_jump_threshold.base >> (8 * 3)) & 0xFF;
      *(outbuffer + offset + 4) = (u_revolute_jump_threshold.base >> (8 * 4)) & 0xFF;
      *(outbuffer + offset + 5) = (u_revolute_jump_threshold.base >> (8 * 5)) & 0xFF;
      *(outbuffer + offset + 6) = (u_revolute_jump_threshold.base >> (8 * 6)) & 0xFF;
      *(outbuffer + offset + 7) = (u_revolute_jump_threshold.base >> (8 * 7)) & 0xFF;
      offset += sizeof(this->revolute_jump_threshold);
      union {
        bool real;
        uint8_t base;
      } u_avoid_collisions;
      ...
      *(outbuffer + offset + 0) = (u_avoid_collisions.base >> (8 * 0)) & 0xFF;
      ...
      union {
        double real;
        uint64_t base;
      } u_max_cartesian_speed;
      u_max_cartesian_speed.real = this->max_cartesian_speed;
      *(outbuffer + offset + 0) = (u_max_cartesian_speed.base >> (8 * 0)) & 0xFF;
      *(outbuffer + offset + 1) = (u_max_cartesian_speed.base >> (8 * 1)) & 0xFF;
      *(outbuffer + offset + 2) = (u_max_cartesian_speed.base >> (8 * 2)) & 0xFF;
      *(outbuffer + offset + 3) = (u_max_cartesian_speed.base >> (8 * 3)) & 0xFF;
      *(outbuffer + offset + 4) = (u_max_cartesian_speed.base >> (8 * 4)) & 0xFF;
      *(outbuffer + offset + 5) = (u_max_cartesian_speed.base >> (8 * 5)) & 0xFF;
      *(outbuffer + offset + 6) = (u_max_cartesian_speed.base >> (8 * 6)) & 0xFF;
      *(outbuffer + offset + 7) = (u_max_cartesian_speed.base >> (8 * 7)) & 0xFF;
      offset += sizeof(this->max_cartesian_speed);
      return offset;
    }
    ...
    virtual int deserialize(unsigned char *inbuffer) override
    {
      ...
      u_prismatic_jump_threshold.base = 0;
      u_prismatic_jump_threshold.base |= ((uint64_t) (*(inbuffer + offset + 0))) << (8 * 0);
      u_prismatic_jump_threshold.base |= ((uint64_t) (*(inbuffer + offset + 1))) << (8 * 1);
      u_prismatic_jump_threshold.base |= ((uint64_t) (*(inbuffer + offset + 2))) << (8 * 2);
      u_prismatic_jump_threshold.base |= ((uint64_t) (*(inbuffer + offset + 3))) << (8 * 3);
      u_prismatic_jump_threshold.base |= ((uint64_t) (*(inbuffer + offset + 4))) << (8 * 4);
      u_prismatic_jump_threshold.base |= ((uint64_t) (*(inbuffer + offset + 5))) << (8 * 5);
      u_prismatic_jump_threshold.base |= ((uint64_t) (*(inbuffer + offset + 6))) << (8 * 6);
      u_prismatic_jump_threshold.base |= ((uint64_t) (*(inbuffer + offset + 7))) << (8 * 7);
      this->prismatic_jump_threshold = u_prismatic_jump_threshold.real;
      offset += sizeof(this->prismatic_jump_threshold);
      union {
        double real;
        uint64_t base;
      } u_revolute_jump_threshold;
      u_revolute_jump_threshold.base = 0;
      u_revolute_jump_threshold.base |= ((uint64_t) (*(inbuffer + offset + 0))) << (8 * 0);
      u_revolute_jump_threshold.base |= ((uint64_t) (*(inbuffer + offset + 1))) << (8 * 1);
      u_revolute_jump_threshold.base |= ((uint64_t) (*(inbuffer + offset + 2))) << (8 * 2);
      u_revolute_jump_threshold.base |= ((uint64_t) (*(inbuffer + offset + 3))) << (8 * 3);
      u_revolute_jump_threshold.base |= ((uint64_t) (*(inbuffer + offset + 4))) << (8 * 4);
      u_revolute_jump_threshold.base |= ((uint64_t) (*(inbuffer + offset + 5))) << (8 * 5);
      u_revolute_jump_threshold.base |= ((uint64_t) (*(inbuffer + offset + 6))) << (8 * 6);
      u_revolute_jump_threshold.base |= ((uint64_t) (*(inbuffer + offset + 7))) << (8 * 7);
      this->revolute_jump_threshold = u_revolute_jump_threshold.real;
      offset += sizeof(this->revolute_jump_threshold);
      union {
        bool real;
        uint8_t base;
      ...
      u_max_cartesian_speed.base = 0;
      u_max_cartesian_speed.base |= ((uint64_t) (*(inbuffer + offset + 0))) << (8 * 0);
      u_max_cartesian_speed.base |= ((uint64_t) (*(inbuffer + offset + 1))) << (8 * 1);
      u_max_cartesian_speed.base |= ((uint64_t) (*(inbuffer + offset + 2))) << (8 * 2);
      u_max_cartesian_speed.base |= ((uint64_t) (*(inbuffer + offset + 3))) << (8 * 3);
      u_max_cartesian_speed.base |= ((uint64_t) (*(inbuffer + offset + 4))) << (8 * 4);
      u_max_cartesian_speed.base |= ((uint64_t) (*(inbuffer + offset + 5))) << (8 * 5);
      u_max_cartesian_speed.base |= ((uint64_t) (*(inbuffer + offset + 6))) << (8 * 6);
      u_max_cartesian_speed.base |= ((uint64_t) (*(inbuffer + offset + 7))) << (8 * 7);
      this->max_cartesian_speed = u_max_cartesian_speed.real;
      offset += sizeof(this->max_cartesian_speed);
     return offset;
    }
